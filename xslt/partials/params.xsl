...
<xsl:stylesheet 
    ...
    <xsl:param name="directory_name">schnitzler-kultur</xsl:param>
    <xsl:param name="project_title">Konzert-, Theater-, Kino-besuche und Teilahme an kulturellen Veranstaltungen von Arthur Schnitzler</xsl:param>
    <xsl:param name="redmine_id">18716</xsl:param>
    <xsl:param name="project_short_title">schnitzler-kultur</xsl:param>
