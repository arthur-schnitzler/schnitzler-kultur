#!/usr/bin/env python3
"""
Script to process XML files in data/indices/list*.xml and data/editions/listevent.xml
and extract xml:id values to generate a CSV file with id, uri, and domain columns.
"""
...
def process_xml_files():
    ...
    # Add listevent.xml from data/editions/
    xml_files.append('./data/editions/listevent.xml')
                    ...
                    if child.tag.endswith('}list') or 'list' in child.tag:
                        for grandchild in child:
                            ...
                            if xml_id:
                                ...
                                # 2) concat('https://schnitzler-kultur.acdh.oeaw.ac.at/', @xml:id, '.html')
                                uri_value = f'https://schnitzler-kultur.acdh.oeaw.ac.at/{xml_id}.html'

                                # 3) "schnitzler-kultur"
                                domain_value = "schnitzler-kultur"
